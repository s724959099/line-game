...
class SpyGame(db.Model):
    ...
    def init_images(self):
        self.position_images = [
            ...
            ("百貨公司", "http://i.imgur.com/uCkvDXj.jpg",
             ["櫃姐", "小P孩", "保全", "清潔阿姨", "客人", "董事長"]),
            ("迪士尼", "http://i.imgur.com/5DRre9V.jpg",
             ["小丑", "米奇", "唐老鴨", "高飛", "海盜船長", "白雪公主", "小熊維尼", "尼莫", "多莉", "樂樂", "巴斯光年", "毛怪", "胡迪", ]),
            ("星際大戰", "http://i.imgur.com/zlzctzh.jpg",
             ["黑武士", "尤達", "天行者", "複製人士兵"]),
            ("白宮", "http://i.imgur.com/27z23dr.jpg",
             ["總通先生", "總統夫人", "保鑣", "殺手", "司機", "園丁", "廚師"]),
            ("西遊記", "http://i.imgur.com/9xxHzfZ.jpg",
             ["吸油面紙", "孫悟空", "唐三藏", "沙悟淨", "豬八戒", "牛魔王", "鐵扇公主", ]),
            ("夜市", "http://i.imgur.com/zBPjQCO.jpg",
             ["射氣球的客人", "小吃攤販", "客人", "警衛", "臭豆腐老闆", "牛排店老闆", ]),
            ("棒球場", "http://i.imgur.com/DEW2Kk4.jpg",
             ["陳金鋒", "球員", "教練", "撿球小弟", "啦啦隊美女", "賣爆米花的人", ]),
            ("北極", "http://i.imgur.com/fX2DLnj.jpg",
             ["北極熊", "海狗", "探勘家", "愛斯基摩人", ]),
            ("尼斯湖", "http://i.imgur.com/NhV1OQH.jpg",
             ["尼斯湖大水怪", "尼斯湖大內褲", "遊客", "漁夫", ]),
            ("海盜船", "",
